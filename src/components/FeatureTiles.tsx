...
const FeatureTiles: React.FC = () => {
    ...
    const widgets = [
        ...
        <div key="widget4" className="w-[280px] md:w-auto flex-shrink-0 md:flex-shrink rounded-[2rem] bg-gradient-to-br from-[#064e3b] via-[#0d4a3a] to-[#0f2e2a] p-4 relative overflow-hidden border border-emerald-500/30 shadow-[inset_0_0_30px_rgba(0,0,0,0.6),0_0_40px_rgba(16,185,129,0.15)] group h-[500px] md:h-full md:min-h-[400px] hover:shadow-[0_0_60px_rgba(16,185,129,0.25)] transition-all duration-300">
            {/* Blueprint grid */}
    ...
    // Create infinite loop by duplicating widgets
